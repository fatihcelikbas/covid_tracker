# Script to reformat JHU data from scratch
# Modified from Edward Parker's codebase https://github.com/eparker12/nCoV_tracker
...
write.csv(jhu_merge, "input_data/jhu_data.csv", row.names = FALSE)
...
# save file
write.csv(collated_data, "input_data/coronavirus.csv", row.names=FALSE)
rm(list = ls())